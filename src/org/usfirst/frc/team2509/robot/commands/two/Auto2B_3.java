 ...
 *3			 D
 *
 *We are going to the 'B' position from '2'
 */
public class Auto2B_3 extends CommandGroup {
    ...
    public Auto2B_3() {
    	...
    	addSequential(new DriveTurn(55));
    	addSequential(new DriveTurnCorrection(55));
    	addSequential(new DriveForward(39.7));
