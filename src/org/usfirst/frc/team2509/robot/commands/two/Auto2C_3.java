 ...
 *3			 D
 *
 *We are going to the 'C; position from '2'
 */
public class Auto2C_3 extends CommandGroup {
    ...
    public Auto2C_3() {
    	...
    	addSequential(new DriveTurn(-69.8));
    	addSequential(new DriveTurnCorrection(-69.8));
    	addSequential(new DriveForward(101.2)); 
    	addSequential(new DriveTurn(69.8));
    	addSequential(new DriveTurnCorrection(69.8));
